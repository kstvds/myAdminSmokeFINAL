...
public class Accommodation_booking_3rdparty_multiroom {
	...
	Logger logger = Logger.getLogger("Accommodation_booking_3rdparty_multiroom");
	...
	public void bookthirdpartymultiroom(String browsername) throws Exception {
		...
		try {
			...
			username.clear();
			username.sendKeys(excel.getData(11, 1, 0));
			WebElement password = driverqa.findElement(LoginPage.pwd);
			password.clear();
			password.sendKeys(excel.getData(11, 1, 1));
		...
		try {
			...
			driverqa.findElement(Operations.company).sendKeys(excel.getData(11, 4, 0));
			Thread.sleep(1000);
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_3rdparty_multiroom/Customer-list.jpg");
		...
		try {
			...
			driverqa.findElement(NewAccoBooking.AccomUnit).sendKeys(excel.getData(11, 7, 0));
			Thread.sleep(2000);
			action.sendKeys(Keys.ARROW_DOWN).build().perform();
			action.sendKeys(Keys.ENTER).build().perform();
			driverqa.findElement(NewAccoBooking.inDate).clear();
			driverqa.findElement(NewAccoBooking.inDate).sendKeys(excel.getData(11, 10, 0));
			driverqa.findElement(NewAccoBooking.outDate).clear();
			driverqa.findElement(NewAccoBooking.outDate).sendKeys(excel.getData(11, 10, 1));
			String expected = excel.getData(11, 7, 0);
			 ...
			 * Thread.sleep(2000);
			 */
			driverqa.findElement(MultiAccothirdParty.Plusroom).click();
			
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccothirdParty.adult1));
			
			Select adult1 = new Select(driverqa.findElement(MultiAccothirdParty.adult1));
			adult1.selectByIndex(0);
			
			Select adult2 = new Select(driverqa.findElement(MultiAccothirdParty.adult2));
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_3rdparty_multiroom/Search-Result.jpg");
		...
		try {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccothirdParty.thirdpartyroomOne));
			driverqa.findElement(MultiAccothirdParty.thirdpartyroomOne).click();
			logger.info("Room Type 1 Selected");
						
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccothirdParty.thirdpartyroomTwo));
			driverqa.findElement(MultiAccothirdParty.thirdpartyroomTwo).click();
			logger.info("Room Type 2 Selected");
			
			test.log(LogStatus.INFO, "Start Booking");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accommodation_booking_3rdparty_multiroom/Selected-room-available.jpg");
			Thread.sleep(1000);
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccothirdParty.thirdpartyTWOroomProcede));
			driverqa.findElement(MultiAccothirdParty.thirdpartyTWOroomProcede).click();
			Thread.sleep(2000);
			
			
			
			logger.info("Entering Passenger details");
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccothirdParty.paxFname1));
			driverqa.findElement(MultiAccothirdParty.paxFname1).sendKeys(excel.getData(11, 14, 0));
			Thread.sleep(2000);
			driverqa.findElement(MultiAccothirdParty.paxLname1).sendKeys(excel.getData(11, 14, 1));
			Select passengertitle = new Select(driverqa.findElement(MultiAccothirdParty.paxtitle1));
			passengertitle.selectByIndex(1);
			driverqa.findElement(NewAccoBooking.acceptChkBX).click();
			
			
			
			driverqa.findElement(MultiAccothirdParty.paxFname2).sendKeys(excel.getData(11, 14, 3));
			Thread.sleep(2000);
			driverqa.findElement(MultiAccothirdParty.paxLname2).sendKeys(excel.getData(11, 14, 4));
			Select passengertitle2 = new Select(driverqa.findElement(MultiAccothirdParty.paxtitle2));
			passengertitle2.selectByIndex(1);
			driverqa.findElement(MultiAccothirdParty.accptchK2).click();
			
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					"D:/Test Repository/Test Screenshots/Accommodation_booking_3rdparty_multiroom/Passenger-Details.jpg");
			driverqa.findElement(NewAccoBooking.bookBtn).click();
			logger.info("Entered Passenger details");
			Thread.sleep(4000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accommodation_booking_3rdparty_multiroom/Confirm-Booking.jpg");
			...
			Thread.sleep(2000);*/
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccothirdParty.confirmStatus1));
			String actualbookingstatus1 = driverqa.findElement(MultiAccothirdParty.confirmStatus1).getText();
			String actualbookingstatus2 = driverqa.findElement(MultiAccothirdParty.confirmStatus2).getText();
			...
			logger.info("Hotel Multi Room Book Complete");
		} catch (Exception e) {
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
